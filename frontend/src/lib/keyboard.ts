...
// Re-export from hooks layer for React Hook usage
...
// Direct implementation for backward compatibility - NOT a React Hook
export function setupGlobalShortcuts(handlers: ShortcutHandlers = {}) {
